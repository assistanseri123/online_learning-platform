...
const Dashboard = () => {
    ...
    return (
        <div className="dashboard-container"style={{borderRadius:"50px 50px"}}>
            <h2 className="dashboard-title"style={{color:"red"}}>Dashboard</h2>

            <div className="user-stats">
                <div className="stat-card"style={{backgroundColor:"green"}}>
                    <h3 style={{color:"bule"}}>{userStats.enrolledCourses}</h3>
                    <p style={{color:"bule"}}>Enrolled Courses</p>
                </div>
                <div className="stat-card"style={{backgroundColor:"green"}}>
            ...
            <div className="activities-section">
                <h3 style={{color:"pink"}}>Recent Activities</h3>
                <ul>
